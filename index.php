...
<section class="jumbotron">
    <div class="container">
        ...
        <button class="btn btn-primary">Quel est l'origine ?</button>
    </div>
    <h2>Collaboration dans le monde du football</h2>
    <p>On imagine que le monde du football est un monde fermé et hostile. On peut détruire ce cliché grâce à cette
...
<section class="jumbotron">
    ...
    <div>
        <p>image</p>
        <button class="btn btn-primary">Qui est derrière tout ce concept ?</button>
    </div>
</section>
